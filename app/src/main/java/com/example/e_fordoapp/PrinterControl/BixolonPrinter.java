package com.example.e_fordoapp.PrinterControl;
...
//                    strOption += EscapeSequence.getString(26);
    ...
    public long setPDFLicenseKey(String key){
        long result = BXLCommonConst._BXL_RC_FAIL;

        try {
            result = posPrinter.setPDFLicenseKey(key);
        } catch (JposException e) {
            e.printStackTrace();
            return BXLCommonConst._BXL_RC_FAIL;
        }
